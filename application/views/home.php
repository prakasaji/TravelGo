 ...
 <div class="carousel carousel-slider center" data-indicators="true">
  ...
  <div style="text-align: left" class="carousel-item blue lighten-1 white-text" href="#one!">
    ...
    if($this->session->userdata('auth_user')){
      ...
      <p class="white-text">Nikmati berbagai kemudahan dalam membeli tiket hanya di Travelin.aja</p>
      <?php
    }else{
      ?>
      <h3 style="margin-top: 100px" class="light">SELAMAT DATANG DI Travel.in</h3>
