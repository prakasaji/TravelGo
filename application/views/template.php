...
<body>
    ...
    <nav class="nav-material grey lighten-5">
      <div class="nav-wrapper">
        <a style="padding-left: 20px;padding-top: 3px" href="<?= site_url() ?>" class="brand-logo">
          <img class="img-brand" src="<?= base_url() . "assets/" ?>images/biru-logo.png">
        </a>
  ...
  <footer class="page-footer blue">
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          <h5 class="white-text">
            <img src="<?= base_url('assets/images/putih-logo.png') ?>">
          </h5>
    ...
    <div class="footer-copyright blue darken-2">
      <div class="container">
        <span>Copyright &copy; 2022 <a class="grey-text text-lighten-4" href="<?= base_url() ?>" target="_blank">Travelin.aja</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="<?= base_url() ?>">Prakas Aji Pratama</a></span>
      </div>
    </div>
  </footer>
